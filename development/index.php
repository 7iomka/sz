...
<body>
  <div class="site-wrapper">
    ...
    <header class="site-header s1 inverted">
        ...
        <div class="row">
          ...
          <div class="col col--6-of-12 top-pulled">
            <div class="header-contacts">
              ...
              <p class="small-text yellow"><a class="brown underline" href="#">Перезвоним через 10 минут</a></p>
        ...
        <div class="row header-parallax-container">
          <div class="col header-col">
            <div class="title-area">
              ...
              <a href="#" class="btn btn--brown btn--medium btn--bordered" rel="Узнать подробнее об акции">Узнать подробнее об акции</a>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="grant__list">
            <div class="col col--4-of-12 grant__item">
          ...
          <div class="grant-faq__steps">
            <div class="col col--4-of-12 grant-faq__step">
              <div class="grant-faq__step-number">
                <svg class="grant-faq__step-number-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="107" height="45" viewBox="0 0 107 45">
            ...
            <div class="col col--4-of-12 grant-faq__step">
              <div class="grant-faq__step-btn">
                <a href="#" class="btn btn--brown btn--small btn--bordered ">Заполнить анкету</a>
              </div>
              ...
              <div class="grant-faq__step-number">
                <svg class="grant-faq__step-number-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="125" height="45" viewBox="0 0 125 45">
            ...
            <div class="col col--4-of-12 grant-faq__step">
              <div class="grant-faq__step-number">
                <svg class="grant-faq__step-number-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="126" height="45" viewBox="0 0 126 45">
      ...
      <div class="container">
        ...
        <div class="col col--6-of-12">
          <div class="vk-container">
            ...
            VK.init({apiId: 5636245, onlyWidgets: true});
          </script>
    ...
    <section class="portfolio s5 inverted" id="portfolio">
      <div class="project project--1">
        ...
        <div class="container">
          <div class="row">
            <img src="/img/portfolio/i1.jpg" alt="" class="project__img">
            <div class="project__desc">
              <div class="project__title">швейное объединение “космос” производство и продажа шапок-ушанок</div>
              <a href="" class="btn btn--brown btn--small project__link">Перейти на сайт</a>
      ...
      <div class="project project--2 inverted">
        <img src="/img/portfolio/bg2.jpg" alt="" class="project__bg">
        <div class="container">
          <div class="row">
            <img src="/img/portfolio/i2.jpg" alt="" class="project__img">
            <div class="project__desc">
      ...
      <div class="project project--3">
        <img src="/img/portfolio/bg3.jpg" alt="" class="project__bg">
        <div class="container">
          <div class="row">
            <img src="/img/portfolio/i3.jpg" alt="" class="project__img">
            <div class="project__desc">
              ...
              <div class="col col--6-of-12 col--am col--push-6-of-12">
                <div class="argument__details">
                  ...
                  <div class="argument__desc">
                    <ul>
                      <li>
                        <p><span class="brown">1.</span> Полный глубокий маркетинговый анализ</p></li>
                      <li>
                        <p><span class="brown">2.</span> Выявление сильных и слабых сторон Вашей компании и Ваших конкурентов.</p></li>
                      <li>
                        <p><span class="brown">3.</span> Прозвон всех Ваших конкурентов для оценки качества обработки заявок.</p></li>
                      <li>
                        <p><span class="brown">4.</span> Выявление источников трафика, которыми пользуются Ваши конкуренты.</p></li>
                      <li>
                        <p><span class="brown">5.</span> Все собранные данные собираются в единую аналитическую таблицу, по данным которой составляется ваше УТП - уникальное торговое предложение.</p></li>
                    </ul>
                  </div>
                  <div class="argument__sep"></div>
                  <div class="argument__totals">
              ...
              <div class="col col--6-of-12 col--am">
                <div class="argument__details">
                  ...
                  <div class="argument__desc">
                    <ul>
                      <li>
                        <p>1. Выстраивание маркетинговой стратегии</p></li>
                      <li>
                        <p>2. Определяем какого типа нужен лендинг (мультилендинг, лендинг с динамическими
                        заголовками, геотаргетинг)</p></li>
                      <li>
                        <p>3. Выбираем наиболее рентабельные источники трафика и площадки для рекламы.</p></li>
            ...
            <div class="row">
              <div class="col col--6-of-12 col--am col--push-6-of-12">
                <div class="argument__details">
                  ...
                  <div class="argument__desc">
                    Верстка и программирование сайта. При создании сайта мы используем самые <br />последние технологии программирования и верстки, благодаря чему Ваш сайт будет корректно отображаться во всех браузерах, на всех компьютерах и мобильных устройствах
                  </div>
                  <div class="argument__sep"></div>
                  <div class="argument__totals">
    ...
    <section class="get-audit s7 inverted">
      ...
      <div class="container container--relative">
        <div class="row">
          ...
          <div class="site-form site-form--audit">
              <form method="POST" action="/ajax.php">
                    ...
                    <button type="submit" name="submit-btn" class="btn btn--brown btn--large btn--bordered btn--action-submit">Получить бесплатный аудит</button>
            ...
            <div class="row">
              ...
              <div class="col col--5-of-12 col--am">
                <div class="argument__details">
                  ...
                  <div class="argument__desc">SЕО Лендинг - это наша уникальная методика создания сайта с высокой конверсией, который затем продвигается в SЕО. Данный сайт представляет из себя многостраничный сайт, каждая из страниц которого - отдельный лендинг пейдж, заточенный для продвижения под определенные запросы.</div>
                  <div class="argument__sep"></div>
                  <div class="argument__totals">
                    <p class="argument__total strong">Стоимость SЕО-лендинга<br />рассчитывается индивидуально</p>
                  </div>
                  <a href="#" class="btn btn--brown btn--large seo-landing__btn">Рассчитать стоимость seo-лендинга</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="portfolio-gallery s9 inverted">
          <h2 class="beforeAnim reverse--contast"><span>Некоторые из наших работ</span></h2>
          <div class="gallery__container">
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/dolg2.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Альянс системного консалтинга
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/printer.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Оргцентр химки
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/kartgeoznak.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Картгеознак
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/floating.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Флоатинг камеры
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/kadastr2.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Оспаривание кадастровой стоимости
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/kinderevent.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Фабрика детских праздников
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/orionra.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Orion gifts, брендированная канцелярия
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/rose.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Доставка роз по москве
                </span></a>
            </div>
            <div class="gallery__item">
                <a href="" class="gallery__item-img-wrapper"><img src="/img/gallery/best-event.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
