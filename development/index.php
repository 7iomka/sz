        ...
        <section class="portfolio-gallery s9 inverted" id="portfolio">
            ...
            <div class="gallery__container">
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="1" data-remodal-target="get_zoomable_image"><img src="/img/gallery/dolg2.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Альянс системного консалтинга
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="2" data-remodal-target="get_zoomable_image"><img src="/img/gallery/printer.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Оргцентр химки
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="3" data-remodal-target="get_zoomable_image"><img src="/img/gallery/kartgeoznak.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Картгеознак
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="4" data-remodal-target="get_zoomable_image"><img src="/img/gallery/floating.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Флоатинг камеры
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="5" data-remodal-target="get_zoomable_image"><img src="/img/gallery/kadastr2.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Оспаривание кадастровой стоимости
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="6" data-remodal-target="get_zoomable_image"><img src="/img/gallery/kinderevent.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Фабрика детских праздников
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="7" data-remodal-target="get_zoomable_image"><img src="/img/gallery/orionra.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Orion gifts, брендированная канцелярия
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="8" data-remodal-target="get_zoomable_image"><img src="/img/gallery/rose.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                  Доставка роз по москве
                </span></a>
                </div>
                <div class="gallery__item">
                    <a href="#" class="gallery__item-img-wrapper portfolioGallery__link" data-project-id="9" data-remodal-target="get_zoomable_image"><img src="/img/gallery/best-event.jpg" alt="" class="gallery__item-img"><span class="gallery__item-title">
                ...
                var b = /iPhone/i,
                    ...
                    r = function(a) {
                        ...
                        if ("undefined" != typeof s[1] && (r = s[0]), s = r.split("Twitter"), "undefined" != typeof s[1] && (r = s[0]), this.apple = {
                            ...
                            }, this.seven_inch = q(p, r), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch, this.phone = this.apple.phone || this.android.phone || this.windows.phone,
                            this.tablet = this.apple.tablet || this.android.tablet || this.windows.tablet, "undefined" == typeof window) return this
                    },
                    s = function() {
                        var a = new r;
                        return a.Class = r, a
                    };
                "undefined" != typeof module && module.exports && "undefined" == typeof window ? module.exports = r : "undefined" != typeof module && module.exports && "undefined" != typeof window ? module.exports = s() : "function" == typeof define &&
